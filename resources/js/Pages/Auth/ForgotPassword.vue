	...
	<JetAuthenticationCard class="background">
		...
		<form @submit.prevent="submit">
			...
			<div class="flex items-center justify-end mt-4">
				<JetButton class="w-full flex justify-center bg-indigo-700 hover:bg-indigo-500" :class="{'opacity-25': form.processing}" :disabled="form.processing"> Email Password Reset Link </JetButton>
			</div>
		</form>
...
<style>
.background {
	background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("/images/init/artschool07.jpeg");
	height: 100%;
