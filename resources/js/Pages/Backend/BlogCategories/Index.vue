...
export default {
	...
	setup() {
		...
		function deleteLocation() {
			Inertia.delete(route("app.blog-categories.destroy", location_id.value), {
				preserveState: true,
				preserveScroll: true,
				onSuccess: (page) => {
					open.value = false
