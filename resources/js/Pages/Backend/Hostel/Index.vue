						...
						<table class="min-w-full divide-y divide-gray-200">
							<thead class="bg-brandColor">
								<tr>
									...
									<th scope="col" class="px-3 py-2 lg:px-6 lg:py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Owner Name</th>
									<th scope="col" class="px-3 py-2 lg:px-6 lg:py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Owner Number</th>
									<th scope="col" class="px-3 py-2 lg:px-6 lg:py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Area</th>
									<th scope="col" class="px-3 py-2 lg:px-6 lg:py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">address</th>
								...
								<tr v-for="(hostel, index) in hostels" :key="index">
									...
									<td class="px-6 py-4 whitespace-nowrap">
										<div class="flex justify-start items-center space-x-2">
											<button type="button" @click="edit(hostel.id)">
												<PencilAltIcon class="h-6 text-green-500" />
											</button>
											<button type="button" @click="openModel(hostel.id)">
