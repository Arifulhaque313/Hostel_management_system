<template>
    <div>
        ...
        <div v-if="imagesLink.length" class="relative grid grid-cols-4 gap-3 items-center border border-gray-200 rounded-sm p-4">
            <!-- <label class="absolute -top-4 z-10 font-semibold text-gray-500 ml-4 bg-gray-50 p-1">Images Preview</label> -->
...
export default {
    ...
    setup(props,context) {
        ...
        const imagesShowlink=ref(Array.isArray(props.images_link)?props.images_link:[])
